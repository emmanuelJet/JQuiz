...
Route::get('login/facebook', 'Auth\Oauth2Controller@redirectToFacebook')->name('facebook');
Route::get('login/facebook/callback', 'Auth\Oauth2Controller@handleFacebookCallback');
Route::get('login/google', 'Auth\Oauth2Controller@redirectToGoogle')->name('google');
Route::get('login/google/callback', 'Auth\Oauth2Controller@handleGoogleCallback');
